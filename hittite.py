...
automata = [(1, {"other":1, "U":2, "Ú":2, "T":2, "K":2, "R":2, "É":2, "I":2, "N":2, "<":3, " ":21}),(2, {"eps":1}),
            (3, {"i":4, "s":11, "other":20}), (4, {">":22, "other":20}),(5, {" ":22, "\n":22, "other":5, "m":6, "a":6, "n":6, "k":6, "u":6, "w":6, "p":6, "w":6, "í":6, "š":6,
                "i":6, "l":6, "ḫ":6, "z":6, "d":6, "e":6, "t":6, "r":6, "á":6, "Š":7, "I":7, "A":7, "<":8}),
            (6, {"eps":5}), (7, {"eps":5}), (8, {'/':9}), (9, {'i':10}), (10, {'>':21}),
            (11, {'u':12, 'other':20}),(12, {'p':13, 'other':20}), (13, {'>':23, 'other':20}), 
            (14, {" ":23, "\n":23, "other":14, 'd':15, "L":15, "Ú":15, "M":15, "E":15, "S":15, "<":24}), (15, {"eps":14}),
            (16, {'s':17, "other":24}),(17, {'u':18, "other":24}),(18, {'p':19}), (19, {'>':1}), (20, {">":21, "other":20}),
            (21, {"eps":1}), (22, {"eps":5}), (23, {"eps":14}),(24, {">":23, "other":24, "/":16})]
...
def handle_state(cur_state, cur_symbol):
        ...
        if cur_state == 7:
            ...
            word[len(word) - 1] += cur_symbol
        if cur_state == 15 and cur_symbol != "d":
            shum.append(cur_symbol)
            word[len(word) - 1] += cur_symbol
        if cur_state == 15 and cur_symbol == "d":
            hit.append(cur_symbol)
